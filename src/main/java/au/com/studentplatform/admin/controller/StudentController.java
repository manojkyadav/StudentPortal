...
public class StudentController {
	...
	public Student update(@PathVariable Integer id, @RequestBody UpdateStudentRequest request) {
		return studentService.updateStudent(id, request.getName(), request.getClassRoomId());
	}
	 ...
	 * // ---------- STUDENTS ----------
	 * 
	 * @GetMapping("/students") public String studentsList(Model model) {
	 * model.addAttribute("students", studentService.findAll()); return
	 * "students/list"; }
	 * 
	 * @GetMapping("/students/new") public String newStudentForm(Model model) {
	 * model.addAttribute("student", new Student());
	 * 
	 * List<ClassRoom> classroomList = classroomService.findAll();
	 * model.addAttribute("classroomList", classroomList); return "students/form"; }
	 * 
	 * @GetMapping("/students/edit/{id}") public String editStudent(@PathVariable
	 * Integer id, Model model) { model.addAttribute("student",
	 ...
	 * 
	 * @PostMapping("/students/save") public String saveStudent(@ModelAttribute
	 * Student student, RedirectAttributes ra) { studentService.save(student);
	 * ra.addFlashAttribute("success", "Student saved"); return
	 * "redirect:/app/students"; }
	 * 
	 * @GetMapping("/students/delete/{id}") public String
	 * deleteStudent(@PathVariable Integer id, RedirectAttributes ra) {
	 * studentService.deleteById(id); ra.addFlashAttribute("success",
	 * "Student deleted"); return "redirect:/app/students"; }
	 */
}
